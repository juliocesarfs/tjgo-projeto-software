...
Este projeto faz parte de um trabalho acadêmico/profissional de engenharia de software, focando em requisitos funcionais e não funcionais, modelagem UML e documentação completa.
...
Organizadas por papéis de usuário, com foco em cenários reais:
...
### Membro da Equipe
- Como membro da equipe, quero editar tarefas em tempo real para colaborar com colegas.
